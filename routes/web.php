...
Route::middleware(['auth'])->group(function () {
    ...
    // AJAX
    Route::get('/button-data',          [ButtonLogController::class, 'buttonDailyData'] )->name('button_daily.data');
    Route::get('/presure-data',         [PresureController::class, 'presureDailyData'] )->name('presure_daily.data');
    ...
    // EXPORT DATA
    Route::post('/button-log-export',           [ButtonLogController::class, 'exportButtonLogs'])->name('export_button.log');
    Route::post('/presure-log-export',          [PresureController::class, 'exportPresureLogs'])->name('export_presure.log');
});
